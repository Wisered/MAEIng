...
l'expérience, et cette expérience est celle de l'incident. Deux mesures en découlent.
...
\cite{nordenflycht2010}. Ce que la section 2.1.2 établissait sur le plan structurel se vérifie ici : la standardisation des qualifications étant produite par le cabinet lui-même, la perturbation du parcours d'apprentissage l'atteint directement.
...
ans, dont la forme appelle une réponse valorisante. Des trois registres, deux seulement sont documentés : le pragmatique, par le gain de délai que tous décrivent, et le moral, par la non-déclaration de l'usage, qui porte sur ce qui a été réellement fait et par qui. Le registre cognitif reste hors d'atteinte du corpus.
Les registres de Suchman permettent de
...
est répandu dans la practice~; un constat dit clivant oppose deux répondants à trois, non
deux groupes.
