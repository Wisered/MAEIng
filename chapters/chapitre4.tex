...
classer ce qui a été dit~: deux seulement sont documentés, le pragmatique par le gain de
délai que tous décrivent, le moral par la non-déclaration de l'usage, qui porte sur ce qui
a été réellement fait et par qui~; le registre cognitif reste hors d'atteinte du corpus.
