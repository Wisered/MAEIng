...
La jonction entre ces deux cadres et la section précédente s'opère par l'ambiguïté de
l'\textit{output} déjà relevée. Si le résultat d'une mission de conseil n'est pas
...
Ce tableau appelle un commentaire. Les cadres retenus ne sont pas juxtaposés~: ils se
