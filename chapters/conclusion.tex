...
été mobilisés ensuite pour rendre le terrain lisible~: la firme
...
qualitative par entretiens semi-directifs a fourni le matériau. Elle a été conduite auprès de
collaborateurs occupant les deux positions de la chaîne de production du livrable, celle qui
rédige et celle qui contrôle. Les résultats qui suivent en sont issus.

\section{Ce que le terrain établit}

Sur l'appropriation, la convergence du panel porte sur des points précis. Les tâches
déléguées relèvent toutes du trai   tement d'un matériau déjà constitué~; l'analyse elle-même ne
...
processus. Le panel situe la valeur future du cabinet du côté du jugement et de la
...
plutôt que détective, en graduant la relecture selon ce que le producteur signale. Elle
permet de déclarer l'usage sans coût au lieu de le rechercher. La deuxième
...
la dimension juridique de ces usages. Elle recouvre la propriété intellectuelle des contenus
produits, la confidentialité des données confiées à un tiers, et surtout l'imputation de la
responsabilité lorsqu'une erreur non détectée parvient au client. Le constat qui l'accompagne est celui d'un
