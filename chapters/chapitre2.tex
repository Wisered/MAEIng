...
les plus proches du terrain étudié.
...
une main-d'{\oe}uvre très qualifiée. Leur capital réside dans l'expertise de leurs membres
bien plus que dans leurs actifs matériels \cite{starbuck1992}. Contrairement à
...
La taxonomie des \textit{professional service firms} de von Nordenflycht
...
qualité formelle du document, l'assurance de celui qui le présente. \mbox{Alvesson}
...
tient pour partie à des signaux (la vitesse de rédaction, la densité apparente d'un
document, la couverture apparente d'un sujet), alors toute technologie qui modifie la
production de ces signaux touche au c{\oe}ur de la prestation et non à sa périphérie.
...
cette distinction en un modèle de conversion des connaissances articulant quatre modes. Ces
modes sont la socialisation (du tacite vers le tacite), l'externalisation (du tacite vers
l'explicite), la combinaison (de l'explicite vers l'explicite) et l'internalisation (de
l'explicite vers le tacite). L'intérêt de ce modèle pour le présent travail tient à ce qu'il permet de nommer
...
donnera pas la lecture d'une synthèse déjà faite. Il en retire la connaissance de ce que le
texte ne dit pas, de ses ambiguïtés, des endroits où l'interprétation est ouverte. En termes du
...
perdent progressivement du terrain. La maîtrise de l'inférence (le raisonnement sur les cas
difficiles, ceux que la routine ne couvre pas) constitue le noyau défendable d'une
juridiction. Transposé au conseil, ce résultat oriente directement la troisième
...
Ces prolongements servent la première et la quatrième questions directrices. Le TAM2 éclaire
...
l'employeur. Ils ne l'ont pas été sur des outils que le collaborateur peut mobiliser de sa
propre initiative, hors du cadre officiel, y compris depuis un terminal personnel. La distinction
...
sa propre situation. C'est exactement la compétence dont la section 2.1 laisse craindre
l'érosion.
...
n'est pas toujours disponible. Appliqué au conseil, le problème posé par les productions
erronées n'est pas seulement que l'outil se trompe~: c'est que le professionnel ne dispose
pas toujours d'une référence indiscutable contre laquelle vérifier. Le contrôle qualité ne peut donc être conçu comme une simple
...
de raisonnement soumise au terrain tient en une phrase~: l'automatisation des tâches
d'analyse déplace le lieu où se forme le jugement professionnel, et la question managériale
est de savoir si l'organisation reconstitue ailleurs ce qu'elle supprime là.
