...
\centering
\small
\begin{tabular}{|p{0.08\linewidth}|p{0.25\linewidth}|p{0.25\linewidth}|p{0.22\linewidth}|}
\hline
\textbf{Thème} & \textbf{Profil junior} & \textbf{Profil senior / manager} & \textbf{Profil directeur} \\
\hline
T1 & Usage vécu et découverte des outils & Usage propre \emph{et} usages observés dans l'équipe & Politique outillage du cabinet \\
\hline
T2 & Sentiment sur son propre apprentissage & Perception de l'évolution des juniors encadrés & Effets sur le modèle de staffing et de formation \\
\hline
T3 & Position en soutenance de livrable & Position en relation client directe & Position sur la proposition de valeur commerciale \\
\hline
T4 & Connaissance et vécu des règles & Rôle effectif dans le contrôle qualité & Arbitrage entre risque et productivité \\
\hline
\end{tabular}
\caption{Adaptation des angles d'interrogation selon le profil du répondant}
